...
def getSubFormulaGraph(formula, op_graph, parent=None, relationship=None, elements=None, edges=None):
	...
	if formula.key == 'not':
		...
		lit, formula = nested_lit(True, parent, formula, elements, edges, 'belief', relationship, 'bel')
	elif formula.key == 'obs':
		lit, formula = nested_lit(True, parent, formula, elements, edges, 'obs', relationship, 'obs')
...
def getFormulaGraph(formula, op_graph, parent=None, relationship=None, elements=None, edges=None):
	...
	if formula.key == 'and':
		for i, child in enumerate(formula.children):
			# if is_nested(child):
			# 	getFormulaGraph(child, op_graph, None, i, elements, edges)
